...
# NOTE (Phase 15, REQ-01): map-name validation moved off the type system onto the
# database (runtime check against maps.names + core.maps.map_name FK backstop). This
# alias is kept defined and exported so the ~27 consumers keep compiling untouched;
# msgspec still enforces presence/type (a missing/non-string name -> 400).
OverwatchMap = str
