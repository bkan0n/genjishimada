...
- [ ] 15-03-PLAN.md — `upload_map_banner` (stripped key) + MapContentService/Repository: create_map guards (empty + collision → 422) + idempotent insert + validate_map_name; unit tests (REQ-02/05/06/07, D-05/D-07) [wave 2]
