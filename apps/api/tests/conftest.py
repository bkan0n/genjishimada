...
def pytest_configure(config: Any) -> None:
    ...
    config.addinivalue_line("markers", "domain_content: Tests for content domain")
    config.addinivalue_line("markers", "domain_tags: Tests for tags domain")
    config.addinivalue_line("markers", "domain_tournaments: Tests for tournaments domain")
