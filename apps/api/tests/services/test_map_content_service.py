"""Unit tests for MapContentRepository and MapContentService.

Repository tests use the real test DB (asyncpg_pool); service tests inject a mock
ImageStorageService and the real-DB MapContentRepository directly into
MapContentService (NO app import — the controller DI graph is wired in plan 15-04).
