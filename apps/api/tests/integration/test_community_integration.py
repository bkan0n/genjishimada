...
class TestGetPlayersPerXPTier:
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/xp/players")
...
class TestGetPlayersPerSkillTier:
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/skill/players")
...
class TestGetMapCompletionStatistics:
    ...
    async def test_happy_path(self, test_client, create_test_map, create_test_user, create_test_completion, unique_map_code):
        ...
        response = await test_client.get(
            "/api/v3/community/statistics/maps/completions",
            params={"code": code},
        )
...
class TestGetMapsPerDifficulty:
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/maps/difficulty")
...
class TestGetPopularMaps:
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/maps/popular")
...
class TestGetPopularCreators:
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/creators/popular")

        assert response.status_code == 401


class TestGetUnarchivedMapCount:
    """GET /api/v3/community/statistics/maps/unarchived"""
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/maps/unarchived")
...
class TestGetTotalMapCount:
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/maps/all")
...
class TestGetMapRecordProgression:
    ...
    async def test_happy_path(self, test_client, create_test_map, create_test_user, unique_map_code):
        ...
        response = await test_client.get(
            f"/api/v3/community/statistics/maps/{code}/user/{user_id}"
        )
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get(
            "/api/v3/community/statistics/maps/TEST01/user/999999999"
        )
    ...
    async def test_invalid_code_format_returns_400(self, test_client):
        ...
        response = await test_client.get(
            "/api/v3/community/statistics/maps/xyz/user/999999999"  # Lowercase
        )
...
class TestGetTimePlayedPerRank:
    """GET /api/v3/community/statistics/ranks/time-played"""
    ...
    async def test_requires_auth(self, unauthenticated_client):
        ...
        response = await unauthenticated_client.get("/api/v3/community/statistics/ranks/time-played")
